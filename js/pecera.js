...
const log = new Log("Daniel Valdivieso-M."); // Pon aquí tu nombre
...
const peces = [
    new Pez("Rubén", 'img/pez1.png', 500, 350, 'horizontal', log),
    new Pez("Laura", 'img/pez2.png', 20, 80, 'zigzag', log),
    new Pez("Tamara", 'img/pez3.png', 300, 100, 'burbujaCascada', log),
    new Pez("Tever", 'img/pez4.png', 280, 250, 'horizontal', log),
    new Pez("Caballito", 'img/caballito.png', 500, 150, 'zigzag', log),
